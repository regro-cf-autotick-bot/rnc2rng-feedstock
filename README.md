...
Once the `conda-forge` channel has been enabled, `rnc2rng` can be installed with:

```
conda install rnc2rng
```

It is possible to list all of the versions of `rnc2rng` available on your platform with:
